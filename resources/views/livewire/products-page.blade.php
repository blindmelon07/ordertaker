        ...
        <div class="w-full pr-2 lg:w-1/4 lg:block">
            ...
            <ul>
              ...
              <li class="mb-4">
                <label for="on_sale" class="flex items-center dark:text-gray-300">
                  ...
                  <span class="text-lg dark:text-gray-400">SALE</span>
                </label>
              </li>
            </ul>
          </div>
          ...
          <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
            ...
            <div>
              ...
              <input type="range" wire:model.live='price_range' class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer" max="50000" value="100000" step="100">
              <div class="flex justify-between ">
                <span class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(1, 'PHP') }}</span>
                <span class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(50000, 'PHP') }}</span>
              </div>
            </div>
          </div>
        </div>
